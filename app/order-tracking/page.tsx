  ...
  const FakeGPSMap = () => (
    <div className="relative w-full h-[400px] bg-slate-100 rounded-[3rem] overflow-hidden border-4 border-white shadow-inner">
      ...
      <div className="absolute left-[40px] bottom-[40px] text-center">
        ...
        <p className="text-[8px] font-black uppercase mt-1">Shop</p>
      </div>
      ...
      <div className="absolute right-[40px] top-[40px] text-center">
        ...
        <p className="text-[8px] font-black uppercase mt-1">Office</p>
      </div>
            ...
            <div className="space-y-10 relative">
                ...
                {[
                    ...
                    <div key={i} className={`flex items-center gap-6 relative z-10 transition-opacity ${s.done ? "opacity-100" : "opacity-30"}`}>
                        ...
                        <span className="font-black uppercase italic text-sm tracking-tight">{s.label}</span>
                    </div>
                ))}
            </div>
          </div>
