...
function FakeGPSMap() {
  return (
    <div className="relative w-full h-[400px] bg-slate-100 rounded-[3rem] overflow-hidden border-4 border-white shadow-inner">
      ...
      >
        <div className="bg-white p-2 rounded-xl shadow-2xl border border-orange-100 relative">
      ...
      {/* Bottom info */}
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-white/90 backdrop-blur-md px-6 py-3 rounded-2xl shadow-xl flex items-center gap-3">
        <Navigation
          size={16}
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-[3rem] p-10 border border-slate-50 shadow-2xl shadow-slate-100/50">
            ...
            <div className="space-y-10 relative">
              ...
              {steps.map((step, index) => (
                <div
                  key={index}
                  className={`flex items-center gap-6 relative z-10 transition-opacity ${
                    step.done
                      ? "opacity-100"
                      : "opacity-30"
                  }`}
          ...
          <div className="bg-slate-900 text-white rounded-[4rem] p-10 shadow-2xl relative overflow-hidden">
            ...
            <p className="text-slate-400 text-sm font-medium leading-relaxed mb-6">
              Mỗi thành viên trong nhóm cần chuyển khoản cho bạn:
            </p>
            ...
            <button className="w-full h-16 bg-white text-slate-900 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-orange-500 hover:text-white transition-all">
