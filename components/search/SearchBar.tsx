    ...
    <div className="relative w-full max-w-md hidden md:block z-50" ref={searchRef}>
      <div className="relative group">
        <input
          ...
          className="w-full bg-slate-50/50 border border-slate-200 text-slate-900 rounded-2xl pl-10 pr-10 py-2 text-xs font-medium outline-none focus:bg-white focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all"
        />
        ...
        <div className="absolute top-full left-0 w-full mt-2 bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
          {results.length > 0 ? (
            <div className="flex flex-col">
              <div className="px-4 py-2 bg-slate-50/80 text-[10px] font-black text-slate-400 uppercase tracking-widest">
                Gợi ý cho bạn
              </div>
              {results.map((product) => (
                <Link
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-[10px] font-black text-orange-500 bg-orange-100 px-1.5 py-0.5 rounded uppercase">
                        {product.category[0]}
                      </span>
